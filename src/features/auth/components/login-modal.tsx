...
export function LoginModal() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="data-[state=open]:duration-500 h-screen w-screen max-w-none m-0 p-16 md:p-8 xl:p-0 rounded-none bg-[#2a2a2a] border-none text-white flex flex-col items-center justify-center">
        <div className="w-full max-w-md space-y-6">
          ...
          <p className="text-xs text-gray-400 text-center mt-4">
            ...
            <br />
            <br />
            We value your privacy and security. Our login process is protected
            by industry-standard encryption and authentication measures. For
            ...
            <Link
              ...
              className="text-blue-400 hover:underline"
              onClick={(e) => handleLinkClick(e, "/data-protection")}
            >
