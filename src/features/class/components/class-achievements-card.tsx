        ...
        <div className="flex flex-1 flex-col gap-6 p-2 sm:p-4 md:p-6 pt-2">
            <Card className="shadow-lg">
                <CardHeader className="space-y-2">
                    <CardTitle className="text-2xl font-bold text-primary">Class Achievements</CardTitle>
                                        ...
                                        <Card key={type} className="hover:shadow-md transition-shadow">
                                            <CardHeader>
                                                <div className="flex items-center gap-3">
                                                    {achievementTypes[type as keyof typeof achievementTypes].icon({
                                                        className: "h-5 w-5 text-primary"
                                                    })}
                                                    <div>
                                                        <CardTitle className="text-lg text-primary">
                                                            {achievementTypes[type as keyof typeof achievementTypes].title}
                                                        </CardTitle>
                                                        <CardDescription>
                                            ...
                                            <CardContent>
                                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                                                    {typeAchievements.map((achievement) => {
                                                        ...
                                                        return renderAchievementWithAvatar(achievement, student);
                                                    })}
                                                </div>
                                            </CardContent>
                                        </Card>
