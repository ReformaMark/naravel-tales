...
export const RecentActivitiesCard = () => {
    ...
    const activities = useQuery(api.parents.getChildRecentActivities, { studentId })
                ...
                <CardContent className="flex-1 flex">
                    {activities.recentProgress.length === 0 ? (
                        <div className="flex flex-col items-center justify-center flex-1 text-muted-foreground">
                            ...
                            <p className="text-sm">Your child hasn&apos;t completed any reading activities yet.</p>
                        </div>
                    ) : (
                                        ...
                                        <CardContent className="p-6">
                                            <div className="flex items-start justify-between">
                                                <div className="space-y-1">
                                                    ...
                                                    <p className="text-sm text-muted-foreground">
                                                        {formatDistanceToNow(progress.lastPlayed, { addSuffix: true })}
                                                    </p>
                                                </div>
                                            ...
                                            <div className="mt-4 grid grid-cols-3 gap-4">
                                                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                                    ...
                                                    <span>Score: {progress.sequenceScore}%</span>
                                                </div>
                                                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                                ...
                                                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                                    ...
                                                    <span>{Math.round(progress.timeSpent / 60)} mins</span>
                                                </div>
                                            </div>
                                            ...
                                            {progress.teacherNotes && (
                                                <div className="mt-4 p-3 bg-muted/50 rounded-lg">
                                                    <p className="text-sm text-muted-foreground">
                                                        <span className="font-medium">Teacher&apos;s Note:</span> {progress.teacherNotes}
                                                    </p>
                                                </div>
                                            )}
                                        </CardContent>
