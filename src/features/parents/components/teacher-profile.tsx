        ...
        <Card className="shadow-lg">
            <CardHeader className="space-y-2">
                <div className="flex justify-between items-start">
                    <div>
                        <CardTitle className="text-2xl font-bold text-primary">Teacher Profile</CardTitle>
            ...
            <CardContent className="space-y-6">
                <div className="flex items-start gap-6">
                    <Avatar className="h-24 w-24">
                        <AvatarFallback className={`rounded-lg text-3xl font-semibold text-white ${avatarColor}`}>
                            {initials}
                        </AvatarFallback>
                    </Avatar>
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Helping students achieve their full potential through personalized learning
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">{teacher.email || 'Not provided'}</p>
                        </div>
                    </div>
