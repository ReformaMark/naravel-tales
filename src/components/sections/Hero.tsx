          ...
          <div className="flex flex-col justify-center items-center lg:items-start space-y-4">
            <div className="space-y-2 text-center lg:text-left">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">
                Discover the joy of reading, wherever you go
              </h1>
            ...
            <div className="flex flex-col gap-2 min-[400px]:flex-row relative">
              ...
              <div className="absolute -bottom-30 -left-[50px] w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 xl:w-64 xl:h-64 hidden lg:block">
                <Image
                  alt="Pointing Owl"
